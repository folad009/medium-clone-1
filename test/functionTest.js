...
describe("retrieves reading list", function () {
  it("retrieves reading list", function () {

    expect(reducer.getReadingList()).to.be.ok;
  });

  it("calls the correct action type on the reducer", function () {

    expect(reducer.getReadingList().type).to.eql("GET_READING_LIST");
  });
});
...
describe("log out", function () {
  it("log out", function () {
    ...
    expect(reducer.logOut()).to.be.ok;
  });

  it("calls the correct action type on the reducer", function () {

    expect(reducer.logOut().type).to.eql("LOGOUT");
  });
});